...
__device__ static void simulateMany(Electron* d_electrons, float deltaTime, int* n, int capacity, curandState* d_rand_states, int i, int poisson_timestep, float3 sim_size, CSData* d_cross_sections){
